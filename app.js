...
let trackList = [
	{
		name: "Would You Mind",
		artist: "HYBS",
		path: "./music/Would You Mind.mp3",
	},
	{
		name: "Banana Pancakes",
		artist: "Jack Johnson",
		path: "./music/Banana Pancakes.mp3",
	},
	{
		name: "Revvin' My Cj7",
		artist: "Summer Salt",
		path: "./music/Revvin' My Cj7.mp3",
	},
	{
		name: "Amazing",
		artist: "Rex Orange County",
		path: "./music/Amazing.mp3",
	},
	{
		name: "Keeping Tabs",
		artist: "Cuco",
		path: "./music/Keeping Tabs.mp3",
	},
];
...
heart.addEventListener("click", () => {
	heart.classList.toggle("clicked"); // Add the 'clicked' class when the heart is clicked
});
